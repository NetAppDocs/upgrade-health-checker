...
[.lead]
You can automate generating Upgrade Health Checker reports to reduce your manual effort when planning ONTAP upgrades for large and complex environments.
