...
[.lead]
You can automate Upgrade Health Checker to reports to reduce 

.Steps

. To ensure the successful creation of your upgrade reports, complete any necessary set up steps and one-time tasks outlined in link:generate-upgrade-health-checker-report.html[Generate an Upgrade Health Checker report].
