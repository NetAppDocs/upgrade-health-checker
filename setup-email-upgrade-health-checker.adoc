...
EMAIL:
  ...
  SMTP:
    ...
    PORT: [<port-number>]
----
. Provide recipient email addresses and configure which report formats are sent by email, for example, HTML, EXCEL, JSON, ALL. Authentication and encryption are also supported in the email feature:
+ 
----
