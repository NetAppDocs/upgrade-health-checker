...
----
+
To learn more about a specific parameter, refer to the Input Parameters Guide in the link:https://mysupport.netapp.com/site/tools/tool-eula/upgrade-health-checker[latest Upgrade Health Checker download files^].
