...
.. Familiarize yourself with the available Upgrade Health Checker parameters, input priority order, and default values for certain parameters by reading the link:upgrade-health-checker-input-parameters.html[Input Parameters Guide for Upgrade Health Checker].
+
