...
---
= Generate an upgrade plan with Upgrade Health Checker
:hardbreaks:
:icons: font
:linkattrs:
:imagesdir: ./media/
...
After you've generated your upgrade plan and cluster report, you can view the link:dashboard-upgrade-health-checker.html[Upgrade Health Checker dashboard] for details of the health status of clusters assessed during the run.
